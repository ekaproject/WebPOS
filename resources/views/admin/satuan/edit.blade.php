...
<div class="max-w-lg mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-3xl font-headline font-extrabold text-primary">Edit Satuan</h1>
            <p class="text-on-surface-variant mt-0.5">Perbarui informasi satuan.</p>
        </div>
    </div>

    <form action="{{ route('admin.satuan.update', $satuan) }}" method="POST"
        ...
        <div>
            ...
            <input type="text" id="nama" name="nama" value="{{ old('nama', $satuan->nama) }}" required
        ...
        <div>
            ...
            <input type="text" id="singkatan" name="singkatan" value="{{ old('singkatan', $satuan->singkatan) }}" required
