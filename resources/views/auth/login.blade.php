...
<head>
    ...
    <title>Login | Manajemen Mega Retail</title>
    ...
    <section class="hidden lg:flex flex-col justify-between p-12 relative overflow-hidden"
        ...
        <div class="relative z-10">
            <div class="flex items-center gap-3 mb-8">
                ...
                <h1 class="font-headline font-extrabold text-2xl tracking-tighter text-white">Mega Retail</h1>
            </div>
    ...
    <section class="p-8 md:p-16 flex flex-col justify-center bg-surface-container-lowest">
        <div class="max-w-md mx-auto w-full">
            ...
            <div class="lg:hidden flex items-center gap-2 mb-12">
                ...
                <span class="font-headline font-bold text-xl tracking-tight text-primary">Mega Retail</span>
            </div>
            ...
            <footer class="mt-12 pt-8 border-t border-surface-variant">
                <p class="text-[10px] text-outline text-center">Properti Rahasia Mega Retail Corp. Akses tanpa izin dilarang. © 2024 Mega Retail.</p>
            </footer>
        </div>
    </section>
